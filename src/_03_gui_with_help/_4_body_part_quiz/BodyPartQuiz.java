...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "wrong, it is arnold the random person");
		}
		...
		if(guess.equalsIgnoreCase("leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "wrong, it is leonardo the dude i never heard of");
		}
		showNextImage();
		guess = JOptionPane.showInputDialog("who is this?");
		if(guess.equalsIgnoreCase("morgan")) {
			...
			JOptionPane.showMessageDialog(null, "wrong, it is morgan the someone");
		}
		showNextImage();
		guess = JOptionPane.showInputDialog("who is this?");
		if(guess.equalsIgnoreCase("jack")) {
			...
			JOptionPane.showMessageDialog(null, "wrong, it is jack the great");
		}
		showNextImage();
